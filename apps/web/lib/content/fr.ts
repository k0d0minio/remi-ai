...
export const fr: Content = {
  ...
  patientLink: {
    ...
    checkIn: {
      ...
      goalQuestion: "{subject} — comment ça se passe cette semaine ?",
      recommendationQuestions: {
        habit: "{subject} — comment ça se passe cette semaine ?",
        activity: "{subject} — comment ça se passe cette semaine ?",
        monitoring: "{subject} — où en êtes-vous cette semaine ?",
      },
      faces: { better: "🙂", stable: "😐", worse: "🙁" },
      directions: { better: "Mieux", stable: "Pareil", worse: "Moins bien" },
      noteLabel: "Un mot, si vous voulez",
      notePlaceholder: "Facultatif",
      skip: "Passer à autre chose",
      errors: {
        invalid_input: "Cette réponse n'a pas pu être enregistrée. Réessayez.",
        rate_limited:
          "Trop de changements d'un coup. Réessayez dans un moment.",
        not_found: "Ce lien n'est plus valable. Demandez-en un nouveau.",
        unknown: "Quelque chose n'a pas fonctionné. Réessayez.",
      },
      progressionTitle: "Ma progression",
      progressionLead:
        "Ce que vous avez répondu ces dernières semaines, et où vous en êtes.",
      stripLabel: "Vos réponses au fil des semaines",
      stripEmpty: "Pas encore de réponse ici.",
      goalsHeading: "Vos objectifs",
      recommendationsHeading: "Vos recommandations",
      mealsThisWeek: "repas notés cette semaine",
      instructionLabel: "Votre consigne du moment",
      empty:
        "Il n'y a encore rien à afficher ici. Cela se remplira à mesure que vous répondrez.",
    },
