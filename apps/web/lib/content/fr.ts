...
export const fr: Content = {
  ...
  patientLink: {
    ...
    profile: {
      title: "Mon profil",
      lead: "Ce que REMI prend en compte pour vous proposer des repas. Vous pouvez le modifier quand vous voulez — votre praticienne le verra.",
      regimeLabel: "Régime alimentaire",
      regimePlaceholder: "végétarien, sans gluten…",
      allergiesLabel: "Allergies",
      allergiesHint:
        "Rien ne vous sera jamais proposé avec ces aliments. Vous pouvez en ajouter et en retirer ; chaque modification est datée et visible par votre praticienne.",
      allergiesPlaceholder: "arachides, fruits à coque…",
      intolerancesLabel: "Intolérances",
      intolerancesPlaceholder: "lactose, gluten…",
      preferencesLabel: "Ce que vous aimez et ce que vous n'aimez pas",
      preferencesPlaceholder: "j'aime le poisson, je déteste le fenouil…",
      ...
      cookingTimeLabel: "Le temps que vous avez pour cuisiner",
      cookingTimeHint: "En général, pas au repas près.",
      cookingTimes: {
        low: "Pressé(e)",
        medium: "Normal",
        high: "Tranquille",
      ...
      saved: "Enregistré",
      errors: {
        invalid_input: "Il y a quelque chose à corriger ci-dessus.",
        rate_limited:
          "Trop de modifications d'un coup — réessayez dans un instant.",
        not_found:
          "Ce lien n'est plus valable. Demandez-en un nouveau à votre praticienne.",
        unknown: "Cela n'a pas pu être enregistré. Réessayez.",
      },
      recordTitle: "Ce que votre praticienne suit",
      recordLead:
        "Cette partie lui appartient : pour la modifier, parlez-lui-en.",
      nameLabel: "Nom",
      ageLabel: "Âge",
      ageUnit: "ans",
      heightLabel: "Taille",
      ...
      supplementsLabel: "Compléments hors protocole",
      recordEmpty: "Rien n'est encore noté ici.",
    },
    disclaimer: {
