...
export const en: Content = {
  ...
  patientLink: {
    ...
    checkIn: {
      ...
      goalQuestion: "{subject} — how has this been going this week?",
      recommendationQuestions: {
        habit: "{subject} — how has this been going this week?",
        activity: "{subject} — how has this been going this week?",
        monitoring: "{subject} — where are you with this this week?",
      },
      faces: { better: "🙂", stable: "😐", worse: "🙁" },
      directions: { better: "Better", stable: "The same", worse: "Worse" },
      noteLabel: "A word, if you like",
      notePlaceholder: "Optional",
      skip: "Ask me something else",
      errors: {
        invalid_input: "That answer could not be saved. Try again.",
        rate_limited: "Too many changes at once. Try again shortly.",
        not_found: "This link is no longer valid. Ask for a new one.",
        unknown: "Something went wrong. Try again.",
      },
      progressionTitle: "My progress",
      progressionLead:
        "What you have answered over the past few weeks, and where you are.",
      stripLabel: "Your answers week by week",
      stripEmpty: "Nothing answered here yet.",
      goalsHeading: "Your goals",
      recommendationsHeading: "Your recommendations",
      mealsThisWeek: "meals logged this week",
      instructionLabel: "Your focus right now",
      empty: "There is nothing to show here yet. It fills in as you answer.",
    },
