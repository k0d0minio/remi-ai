...
export const en: Content = {
  ...
  patientLink: {
    greeting: "Hello",
    lead: "Your REMI space: what was agreed with your practitioner, in one place.",
    navLabel: "Your pages",
    nav: {
      home: "Today",
    ...
    complementsTitle: "Your supplements",
    doseLabel: "Dose",
    timingLabel: "When",
    reasonLabel: "Why",
    pantryTitle: "Pantry & fridge",
    ...
    profile: {
      title: "My profile",
      lead: "What REMI takes into account when suggesting meals. You can change it whenever you like — your practitioner will see it.",
      regimeLabel: "Dietary regime",
      regimePlaceholder: "vegetarian, gluten-free…",
      allergiesLabel: "Allergies",
      allergiesHint:
        "Nothing containing these will ever be suggested to you. You can add and remove them; every change is dated and visible to your practitioner.",
      allergiesPlaceholder: "peanuts, tree nuts…",
      intolerancesLabel: "Intolerances",
      intolerancesPlaceholder: "lactose, gluten…",
      preferencesLabel: "What you like and what you don't",
      preferencesPlaceholder: "I like fish, I can't stand fennel…",
      likesCookingLabel: "Do you enjoy cooking?",
      likesCooking: {
        yes: "Yes",
        somewhat: "A little",
        no: "No",
      },
      cookingTimeLabel: "The time you have to cook",
      cookingTimeHint: "In general, not meal by meal.",
      cookingTimes: {
        low: "In a rush",
        medium: "Normal",
        high: "Unhurried",
      ...
      saved: "Saved",
      errors: {
        invalid_input: "There is something to fix above.",
        rate_limited: "Too many changes at once — try again shortly.",
        not_found:
          "This link is no longer valid. Ask your practitioner for a new one.",
        unknown: "That could not be saved. Please try again.",
      },
      recordTitle: "What your practitioner tracks",
      recordLead: "This part is hers: to change it, talk to her about it.",
      nameLabel: "Name",
      ageLabel: "Age",
      ageUnit: "years",
      heightLabel: "Height",
      weightLabel: "Weight",
      medicationsLabel: "Medication",
      supplementsLabel: "Supplements outside the protocol",
      recordEmpty: "Nothing is noted here yet.",
    },
    disclaimer: {
      title: "Your practitioner stays the reference",
