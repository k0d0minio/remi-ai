 ...
 *
 * The identity is passed in rather than looked up: it comes from the session the
 * group's layout already resolved, so the header cannot show one operator while
 * the gate let a different one through.
 */
export const AdminHeader = ({ name, email, role }: Props) => (
