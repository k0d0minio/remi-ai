 ...
 * notes, its anamnesis and its patient link all go, and there is no undo. The
 * audit trail records who did it and which profile it was, which is the only
 * thing that survives.
 */
    ...
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          ...
          consultation, son anamnèse et son lien patient sont supprimés. Toute
          personne détenant le lien perd l&apos;accès. Il n&apos;y a pas de
          retour en arrière.
        </DialogDescription>
      </DialogHeader>
