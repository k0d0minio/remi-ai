...
- **The front's artifacts, when they exist for the stub's scope:**
  - `.icm/runs/<scope-slug>/01_scope/output/scope.md` — the agreed logic.
  - `.icm/runs/<scope-slug>/02_design/output/design-notes.md` — the approved demo, and the
...
- If revising: the existing `.icm/runs/<slug>/03_define/output/spec.md`.
...
3. **Write the spec** to `.icm/runs/<slug>/03_define/output/spec.md` (template below) — the
...
`.icm/runs/<slug>/03_define/output/spec.md`:
