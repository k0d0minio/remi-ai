...
- `.icm/runs/<slug>/05_verify/output/verify.md` — the quality-gate record.
- `.icm/runs/<slug>/03_define/output/spec.md` — acceptance criteria and problem; they ground the
  notes.
- `.icm/_shared/github.md` — gate read, merge, review-comment calls.
...
3. **Write the release notes, in this PR.** One plain sentence first — _what a user can now do, and
   ...
   - **Ship note** → `.icm/runs/<slug>/06_ship/output/ship-note.md`, fixed template below, with a
...
`.icm/runs/<slug>/06_ship/output/release.md`:
