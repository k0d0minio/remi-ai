...
- D-35 — The prompt is her § 6 example verbatim, both sentences, as the prompt above the box.
- D-36 — The feedback box sits **beside** the one-tap check-in on the home; it does not replace it.
  ...
  stub.
- D-37 — Unread clears on a reply or on « Marquer comme lu »; nothing clears on its own.
- D-38 — Run ahead of `patient-documents-and-links` (5 of 9): both add a migration; whichever merges
